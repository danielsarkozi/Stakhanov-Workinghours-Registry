insert into person(username, password, enabled, role, fullname, education, birth_date, pos) values ('admin', '$2a$04$YDiv9c./ytEGZQopFfExoOgGlJL6/o0er0K.hiGb5TGKHUL8Ebn..', true, 'ROLE_ADMIN', 'Matyas', 'az elet iskolaja', '1868-06-18', 'kiraly');
